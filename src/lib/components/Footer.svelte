		...
		<div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
			<div>
				...
				<ul class="text-gray-500 font-medium">
					...
					<li class="mb-4">
						<a href="/" class="hover:text-gray-800">Brand Center</a>
					</li>
					<li class="mb-4">
			...
			<div>
				...
				<ul class="text-gray-500 font-medium">
					<li class="mb-4">
						<a href="/" class="hover:text-gray-800">Discord Server</a>
					</li>
					<li class="mb-4">
			...
			<div>
				...
				<ul class="text-gray-500 font-medium">
					<li class="mb-4">
						<a href="/" class="hover:text-gray-800">iOS</a>
					</li>
					<li class="mb-4">
						<a href="/" class="hover:text-gray-800">Android</a>
					</li>
					<li class="mb-4">
						<a href="/" class="hover:text-gray-800">Windows</a>
					</li>
					<li class="mb-4">
						<a href="/" class="hover:text-gray-800">MacOS</a>
					</li>
				</ul>
			</div>
		</div>
